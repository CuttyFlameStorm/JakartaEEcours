...
<div class="fenetrePrincipal">
    ...
    <div class="cliqueJoueur" onclick="faireChoix('<%= item %>')">
        <h2>CHI</h2>
        <img src="<%= request.getContextPath() %>/assets/images/chi.png" alt="illustration image CHI">
    </div>
    <% } else if (item.equals("FOU")) { %>
    <div class="cliqueJoueur" onclick="faireChoix('<%= item %>')">
        <h2>FOU</h2>
        <img src="<%= request.getContextPath() %>/assets/images/fou.png" alt="illustration image FOU">
    </div>
    <% } else if (item.equals("MI")) { %>
    <div class="cliqueJoueur" onclick="faireChoix('<%= item %>')">
        <h2>MI</h2>
        <img src="<%= request.getContextPath() %>/assets/images/mi.png" alt="illustration image MI">
    </div>
    <% }
    } %>
